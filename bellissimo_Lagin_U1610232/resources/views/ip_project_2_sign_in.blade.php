...
<div class="topnav" id="myTopnav">
  ...
  <div class="dropdown-content">
  	<a href=""><i class="fa fa-cutlery"> First course & Starter</i></a>
  	<a href=""><i class="fa fa-cutlery"> Second course</i></a>
  	<a href=""><i class="fa fa-birthday-cake"></i> Dessert</a>
    <a href=""><i class="fa fa-beer"> Drinks</i></a>
    <a href="">Fast Food</a>
    <a href="">Vegan</a>
  </div>
  </div> 
...
<div id="popup" class="sign">
  ...
  <form class="sign-content animate" action="/action_page.php">
    ...
    <div class="container">
      ...
      <input type="password" placeholder="Enter Password" name="psw" required><span class="fa fa-eye"></span>
      <div class="container">  
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <span class="psw2">Registration</span>
    </div>
  </form>
</div>
<!-- 
...
<div class="nameOfMeals">
  ...
  <div class="nameOfMeals-content">
    <img src="images/1.png" alt="Grilled Food">
