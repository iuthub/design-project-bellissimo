...
<div class="nameOfMeals">
  <div class="nameOfMeals-content">
     <img src="images/dessert_course_meal/1d.jpg" alt="FirstCourseMeal">
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/2d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/3d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/4d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
      <h3>Milky</h3>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/5d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/6d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/7d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/8d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/9d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/10d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
      <h3>Lakomka</h3>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/11d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
      <h3>Tiramisu</h3>
      <p><i class="fa fa-money"> </i> 25000 sum</p>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/12d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
      <h3>Fruit jelly</h3>
  ...
  <div class="nameOfMeals-content">
    <img src="dessert_course_meal/13d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
  ...
  <div class="nameOfMeals-content">
    <img src="images/dessert_course_meal/14d.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <i style="font-size: 24px;" class="fafafa fa fa-chevron-up "></i>
