...
<div class="nameOfMeals">
  <div class="nameOfMeals-content">
     <img src="images/second_course_meal/1s.jpg" alt="FirstCourseMeal">
    <div class="nameOfCardAndCost">
      <h1>Kavirdok with chicken</h1>
      <p>91 000 sum</p>
    </div>
  </div>
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/2s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Ice cream with fruits</h1>
      <p>26000 sum</p>
    </div>
  </div>
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/3s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Beefy</h1>
      <p>37000 sum</p>
    </div>
  ...
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/4s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Chicken wings</h1>
      <p>28000 sum</p>
    </div>
  ...
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/5s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Salty Beef</h1>
      <p>19000 sum</p>
    </div>
  ...
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/6s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Kotlet of Chicken</h1>
      <p>33000 sum</p>
    </div>
  </div>
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/7s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Dumplings in broth</h1>
      <p>15000 sum</p>
    </div>
  </div>
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/8s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Beef with species</h1>
      <p>56000 sum</p>
    </div>
  </div>
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/9s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Shi Green soup</h1>
      <p>19500 sum</p>
    </div>
  </div>
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/10s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Wings of Bafol</h1>
      <p>48000 sum</p>
    </div>
  </div>
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/11s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
  ...
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/12s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Xe Fish</h1>
      <p>28000 sum</p>
    </div>
  ...
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/13s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Fish with vegetables</h1>
      <p>83000 sum</p>
    </div>
  </div>
  <div class="nameOfMeals-content">
    <img src="images/second_course_meal/14s.jpg" alt="Grilled Food">
    <div class="nameOfCardAndCost">
      <h1>Chicken choice</h1>
      <p>67000 sum</p>
    </div>
  </div>
</div>
