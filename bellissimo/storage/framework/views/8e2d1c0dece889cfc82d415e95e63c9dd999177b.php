...
<div id="popup" class="sign">
  <form class="sign-content animate" action="/User.php">
    ...
    <div class="container">
      ...
      <div class="container">  
      <button type="submit"><a href="<?php echo e(route('login')); ?>">Login</button>
      </div>
      <label>
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <span class="psw2"><a id="registration" href="<?php echo e(route('register')); ?>"> Register</a></span>
    </div>
  </form>
</div>
<!-- 
